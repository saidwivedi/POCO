...
from pocolib.utils.kp_utils import get_common_joint_names
from pocolib.core.constants import pw3d_occluded_sequences, pw3d_test_sequences
...
if __name__ == '__main__':
    result_file = '/is/cluster/sdwivedi/smpl_regressor/logs_is/poco/poco_nflow_condNF_charades/poco_nflow_condNF_charades_ID02_29-10-2022_01-29-54_dataset.valds-3dpw-all/evaluation_results_3dpw-all.pkl'
