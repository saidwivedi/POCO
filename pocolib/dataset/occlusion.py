...
def occlude_with_pascal_objects_kp(im, kp2d, scale, occluders):
    """Returns an augmented version of `im`, containing some occluders from the
    Pascal VOC dataset
    Borrowed from https://github.com/smplbody/hmr-benchmarks/blob/dev/mmhuman3d/data/datasets/pipelines/synthetic_occlusion_augmentation.py
    """
